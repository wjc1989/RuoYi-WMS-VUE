    ...
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="字段信息" name="columnInfo">
        <el-table ref="dragTable" :data="columns" row-key="columnId" :max-height="tableHeight">
          ...
          <el-table-column label="Search方式" min-width="10%">
            <template slot-scope="scope">
          ...
          <el-table-column label="ShowType" min-width="12%">
            <template slot-scope="scope">
              <el-select v-model="scope.row.htmlType">
                ...
                <el-option label="选框" value="radio" />
                <el-option label="复选框" value="checkbox" />
                <el-option label="Date控件" value="datetime" />
          ...
          <el-table-column label="DictType" min-width="12%">
            <template slot-scope="scope">
    ...
    submitForm() {
      ...
      Promise.all([basicForm, genForm].map(this.getFormPromise)).then(res => {
        ...
        if (validateResult) {
          ...
          this.$modal.msgError("表校验未通过，请重新检查提交Content");
        }
      });
    },
    getFormPromise(form) {
