<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="100px" size="medium" class="ry_form">
      <el-form-item label="Wave NO." prop="waveNo">
        <el-input
          ...
          placeholder="Please Input Batch No."
          clearable
          size="small"
    ...
    <WmsTable v-loading="loading" :data="WaveList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="Batch No." align="center" prop="waveNo" v-if="columns[0].visible"/>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        waveNo: [
          { required: true, message: "Batch No. is required", trigger: "blur" }
        ],
      },
      columns: [
            { key: 1, label: "Batch No.", visible:  true  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm(' Do you want delete Batch No."' + waveNo + '"？').then(function() {
