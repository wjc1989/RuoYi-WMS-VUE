<template>
  <div class="app-container">
    ...
    <WmsTable v-loading="loading" :data="wmsReceiptOrderDetailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="Rack Name" align="center" prop="rackId" v-if="columns[4].visible"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="50%" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="108px" inline class="dialog-form-two">
        ...
        <el-form-item label="Rack Name" prop="rackId">
          <el-input v-model="form.rackId" placeholder="Please Input Rack Name" />
        </el-form-item>
  ...
  data() {
    return {
      ...
      columns: [
            ...
            { key: 5, label: "Rack Name", visible:  true  },
